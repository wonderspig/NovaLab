                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg15">
                    	<div class="width100 float_l padding40">
                        	<div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">GIS软件使用</span>
                                <ul class="width100 ul_lis float_l">
                                    ...
                                    <li><a>SketchUp</a></li>
                                    <li>  </li>
                                    <li><a>CityEngine</a></li>

                                </ul>
                            </div>
                            <div class="width100 float_l margin_b40">
                                <span class="width100 color_shenred fon_siz16 float_l margin_b20">GIS开发应用</span>
                                <ul class="width100 ul_lis float_l">
                                    <li><a>ArcGIS(.NET)</a></li>
                                    <li>  </li>
                                    <li><a>QGIS(C++)</a></li>
                                    <li>  </li>
                                    <li><a>MapGIS(.NET)</a></li>
                                    <li>  </li>
                                    <li><a>OpenLayer(js)</a></li>
                                    <li>  </li>
                                    <li><a>LeafLet(js)</a></li>
                                    <li>  </li>
                                    <li><a>BIM</a></li>
                                    <li>  </li>
                                    <li><a>VGIS(C++)</a></li>
                            ...
                            <div class="width100 float_l margin_b40">
                                ...
                                <ul class="width100 ul_lis float_l">
                                	<li class="width100 float_l margin_b15"><a>课程 | 基于C#+ArcEngine的林业系统开发</a></li>
									<li class="width100 float_l margin_b15"><a>课程 | 基于OpenLayer的地址服务</a></li>
                                    <li class="width100 float_l margin_b15"><a>课程 | 基于C++的VGIS原型系统构建</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg16">
                    	<div class="width100 float_l padding40">
                            ...
                            <div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">推荐</span>
                                <ul class="width100 ul_lis float_l">
                                	<li class="width100 float_l margin_b15"><a>课程 | 基于Node.js的个人博客构建</a></li>
									<li class="width100 float_l margin_b15"><a>课程 | 基于HTML5的俄罗斯方块</a></li>
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg17">
                        <div class="width100 float_l padding40">
                            ...
                            <div class="width100 float_l margin_b40">
                                <span class="width100 color_shenred fon_siz16 float_l margin_b20">推荐</span>
                                <ul class="width100 ul_lis float_l">
                                    <li class="width100 float_l margin_b15"><a>课程 | 基于SSM框架的电商系统构建</a></li>
                                    <li class="width100 float_l margin_b15"><a>课程 | 基于Python的新浪微博爬虫</a></li>
                                    <li class="width100 float_l margin_b15"><a>课程 | Muduo源码分析</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg18">
                    	<div class="width100 float_l padding40">
                            ...
                            <div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">推荐</span>
                                <ul class="width100 ul_lis float_l">
                                	<li class="width100 float_l margin_b15"><a>课程 | Redis源码分析</a></li>
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg16">
                    	<div class="width100 float_l padding40">
                            ...
                            <div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">推荐</span>
                                <ul class="width100 ul_lis float_l">
                                	<li class="width100 float_l margin_b15"><a>课程 | 基于Python的神经网络分析</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    	...
                    	<div class="width100 float_l padding40">
                            ...
                            <div class="width100 float_l margin_b40">
                                ...
                                <ul class="width100 ul_lis float_l">
									...
									<li class="width100 float_l margin_b15"><a>课程 | 张磊同学荣获京东机器学习一等奖</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
